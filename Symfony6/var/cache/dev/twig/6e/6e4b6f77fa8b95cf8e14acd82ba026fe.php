...
class __TwigTemplate_19aa1ef8104c37252100252cda73d31e extends Template
{
    private $source;
    private $macros = [];
        ...
        <table>
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["run"]) {
                    ...
                    // line 187
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, twig_get_attribute($this->env, $this->source, $context["run"], "type", [], "any", false, false, false, 187));
                    echo "</th>
                </tr>";
                }
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/Users/morten.thorpe/Serializers/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
